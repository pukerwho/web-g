<div class="overflow-hidden relative bg-dark-lg dark:bg-dark-xl custom-shadow rounded-lg px-2 lg:px-4 py-2 lg:py-4 lg:pb-2 mb-6">
  ...
  <div class="text-gray-200 opacity-75 mb-4">Подписывайся и не пропускай:</div>
  <div class="mb-4">
    <div class="flex items-center mb-2">
      ...
      <div class="text-gray-200">Актуальные новости</div>
    </div>
    <div class="flex items-center mb-2">
      <div class="text-green-500 mr-2">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
      ...
      <div class="text-gray-200">Интересные задачки</div>
    </div>
