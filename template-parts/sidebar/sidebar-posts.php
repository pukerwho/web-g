...
<div class="bg-white dark:bg-dark-xl custom-shadow rounded-lg mb-6">
  ...
  <div>
    <a href="<?php $birgi_current_lang = pll_current_language(); $birgi_post_id = pll_get_post("3668", $birgi_current_lang); echo get_the_permalink($birgi_post_id); ?>" class="block bg-indigo-600 text-gray-200 text-center rounded px-6 py-3"><?php _e("Где купить ссылки на сайт?", "web-g"); ?></a>
  </div>
</div>
<!-- END Біржі посилань -->
